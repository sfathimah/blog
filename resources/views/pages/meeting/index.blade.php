...
<div class="container-fluid">
    <div class="col-6 m-auto">
        <div class="card">
            <div class="card-header">Book an Appointment
            </div>
            <div class="card-body col-10 m-auto">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="service" role="tabpanel">
                        ...
                        <form method="POST" action="{{ route('pages.meeting.search') }}">
                            @csrf
                            <!-- {{ csrf_field() }} -->
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text cil-calendar"></span>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span
                                            class="input-group-text cil-briefcase"></span></div>
                                    <select name="service" id="service" class="form-control">

                                        @php
                                        $service = DB::table('appointmentsettings')->select('service')->get();
                                        @endphp
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text cil-hospital"></span>
                                    </div>
                                    <input id="sel_symp" class="tag-ctn" style="width:400px;" type="text"
                                        name="sel_symp" />
                                    <br>
                                </div>
                            </div>
                            <div class="form-group form-actions text-right">
                                <button class="btn btn-success" type="submit">Search for available slot</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            $(document).ready(function () {
                ...
                var TagSuggest = function (element, options) {
                    ...
                    var defaults = {
                         ...
                         */
                        emptyText: function () {
                            return cfg.editable ? 'Type/click to add symptoms' : 'Click here';
                        },
                        ...
                        maxEntryRenderer: function (v) {
                            return 'Please reduce your entry by ' + v + ' character' + (v > 1 ?
                                's' : '');
                        },
                    ...
                    this.addToSelection = function (items, isSilent) {
                        if (!cfg.maxSelection || _selection.length < cfg.maxSelection) {
                            ...
                            if (valuechanged === true) {
                                ...
                                this.empty();
                                if (isSilent !== true) {
                                    $(this).trigger('selectionchange', [this, this
                                        .getSelectedItems()
                                    ]);
                                }
                            }
                    ...
                    this.expand = function () {
                        if (!cfg.expanded && (this.input.val().length >= cfg.minChars || this
                                .combobox
                                .children().size() > 0)) {
                    ...
                    var self = {
                        ...
                        _displaySuggestions: function (data) {
                            ...
                            if (resHeight < ms.combobox.height() || resHeight <= cfg
                                .maxDropHeight) {
                                ms.combobox.height(resHeight);
                            } else if (resHeight >= ms.combobox.height() && resHeight > cfg
                                .maxDropHeight) {
                                ms.combobox.height(cfg.maxDropHeight);
                            }

                            if (data.length === 1 && cfg.preselectSingleSuggestion === true) {
                                ms.combobox.children().filter(':last').addClass(
                                    'tag-res-item-active');
                            }
                        ...
                        _highlightSuggestion: function (html) {
                            ...
                            if (cfg.matchCase === true) {
                                ...
                                html = html.replace(new RegExp('(' + q + ')(?!([^<]+)?>)',
                                        'gi'),
                                    '<em>$1</em>');
                            }
                            return html;
                        ...
                        _render: function (el) {
                            ...
                            ms.input = $('<input/>', $.extend({
                                id: 'tag-input-' + $('input[id^="tag-input"]')
                                    .length,
                                type: 'text',
                            ...
                            if (cfg.hideTrigger === false) {
                                ms.trigger = $('<div/>', {
                                    id: 'tag-trigger-' + $('div[id^="tag-trigger"]')
                                        .length,
                                    'class': 'tag-trigger',
                        ...
                        _renderComboItems: function (items, isGrouped) {
                            ...
                            $.each(items, function (index, value) {
                                ...
                                resultItemEl.click($.proxy(handlers
                                    ._onComboItemSelected, ref));
                                resultItemEl.mouseover($.proxy(handlers
                                    ._onComboItemMouseOver,
                                    ref));
                                html += $('<div/>').append(resultItemEl).html();
                            });
                            ms.combobox.append(html);
                            _comboItemHeight = ms.combobox.find('.tag-res-item:first')
                                .outerHeight();
                        },
                        ...
                        _renderSelection: function () {
                            ...
                            $.each(_selection, function (index, value) {
                                ...
                                var selectedItemEl, delItemEl,
                                    ...
                                    cfg
                                    .selectionRenderer.call(ref, value) : value[cfg
                                        .displayField];
                                // tag representing selected value
                                if (asText === true) {
                                    selectedItemEl = $('<div/>', {
                                        'class': 'tag-sel-item tag-sel-text ' +
                                            cfg
                                            .selectionCls,
                                        html: selectedItemHtml + (index === (
                                            _selection
                                            .length - 1) ? '' : ',')
                                    }).data('json', value);
                                } else {
                                    selectedItemEl = $('<div/>', {
                                        'class': 'tag-sel-item ' + cfg
                                            .selectionCls,
                                    ...
                                    if (cfg.disabled === false) {
                                        ...
                                        delItemEl.click($.proxy(handlers
                                            ._onTagTriggerClick, ref));
                                    }
                                }
                            ...
                            if (cfg.selectionPosition === 'inner') {
                                ms.input.width(0);
                                inputOffset = ms.input.offset().left - ms.selectionContainer
                                    .offset().left;
                        ...
                        _selectItem: function (item) {
                            ...
                            if (cfg.expandOnFocus === false || _selection.length === cfg
                                .maxSelection) {
                                ms.collapse();
                            }
                            if (!_hasFocus) {
                        ...
                        _sortAndTrim: function (data) {
                            ...
                            if (q.length > 0) {
                                $.each(data, function (index, obj) {
                                    ...
                                    if ((cfg.matchCase === true && name.indexOf(q) > -
                                            1) ||
                                        (cfg.matchCase === false && name.toLowerCase()
                                            .indexOf(q
                                                .toLowerCase()) > -1)) {
                                        if (cfg.strictSuggest === false || name
                                            .toLowerCase()
                            ...
                            $.each(filtered, function (index, obj) {
                                if ($.inArray(obj[cfg.valueField], selectedValues) === -
                                    1) {
                    ...
                    var handlers = {
                        ...
                        _onBlur: function () {
                            ...
                            } else if (ms.input.val() !== '' && cfg.allowFreeEntries ===
                                false) {
                                ms.empty();
                                self._updateHelper('');
                            }
                        ...
                        _onKeyDown: function (e) {
                            ...
                            if (e.keyCode === 9 && (cfg.useTabKey === false ||
                                    (cfg.useTabKey === true && active.length === 0 && ms.input
                                        .val()
                                        .length === 0))) {
                                handlers._onBlur();
                                return;
                            ...
                            switch (e.keyCode) {
                                case 8: //backspace
                                    if (freeInput.length === 0 && ms.getSelectedItems().length >
                                        0 && cfg
                                        .selectionPosition === 'inner') {
                                        _selection.pop();
                                        self._renderSelection();
                                        $(ms).trigger('selectionchange', [ms, ms
                                            .getSelectedItems()
                                        ]);
                                        ms.input.focus();
                                        e.preventDefault();
                        ...
                        _onKeyUp: function (e) {
                            var freeInput = ms.getRawValue(),
                                inputValid = $.trim(ms.input.val()).length > 0 && ms.input
                                .val() !== cfg
                                .emptyText &&
                            ...
                            if ((e.keyCode === 9 && cfg.useTabKey === false) || (e.keyCode >
                                    13 && e
                                    .keyCode < 32)) {
                                if (e.keyCode === 17) {
                                    _ctrlDown = false;
                            ...
                            switch (e.keyCode) {
                                ...
                                case 188: // enter, tab, comma
                                    if (e.keyCode !== 188 || cfg.useCommaKey === true) {
                                        ...
                                        if (inputValid === true && cfg.allowFreeEntries ===
                                            true) {
                                            obj[cfg.displayField] = obj[cfg.valueField] =
                                                freeInput;
                                            ms.addToSelection(obj);
                                    ...
                                    default:
                                        if (_selection.length === cfg.maxSelection) {
                                            self._updateHelper(cfg.maxSelectionRenderer.call(
                                                this,
                                                _selection.length));
                                        } else {
                                            if (freeInput.length < cfg.minChars) {
                                                self._updateHelper(cfg.minCharsRenderer.call(
                                                    this, cfg
                                                    .minChars - freeInput.length));
                                                if (cfg.expanded === true) {
                                                    ms.collapse();
                                                }
                                            } else if (cfg.maxEntryLength && freeInput.length >
                                                cfg
                                                .maxEntryLength) {
                                                self._updateHelper(cfg.maxEntryRenderer.call(
                                                    this, freeInput
                        ...
                        _onTriggerClick: function () {
                            if (ms.isDisabled() === false && !(cfg.expandOnFocus === true &&
                                    _selection
                    ...
                    obj.each(function (i) {
                        ...
                        if (this.nodeName.toLowerCase() === 'select') { // rendering from select
                            ...
                            $.each(this.children, function (index, child) {
                                if (child.nodeName && child.nodeName.toLowerCase() ===
                                    'option') {
                                    options.data.push({
                                        id: child.value,
                                        name: child.text
