...
<div class="container-fluid">
    <div class="col-6 m-auto">
        <div class="card">
            <div class="card-header">My Meeting
            </div>
            <div class="card-body">
                @if(!empty($successMsg))
                ...
                <form method="POST" action="{{ route('pages.meeting.search') }}">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text cil-calendar"></span></div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text cil-briefcase"></span></div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text cil-hospital"></span></div>
